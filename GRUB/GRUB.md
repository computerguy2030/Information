...
Contains "menuentry"s which act as mini scripts similar to .sh files but for grub.
...
<br>
How to modify GRUB menu/boot options:

1. modify:
* /boot/grub/grub.cfg (main)<br>
or
* /etc/grub.d/40_custom (designed for user-added custom boot entries. Combined into grub.cfg after grub update)

2. sudo update-grub
3. reboot

What boot options should I use?
...
Use instructions as stated above but with "loop" device. This is simply a file that acts like a device.
```loopback loop (isofile name) ```

Example:
```
menuentry "Ubuntu" --class ubuntu {
   set isofile="/boot/images/ubuntu-20.04.1-desktop-amd648-21-202.iso"
